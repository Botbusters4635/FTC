package org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines;

import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.BORDER_BOTTOM_Y;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.BORDER_LEFT_X;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.BORDER_RIGHT_X;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.BORDER_TOP_Y;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.CENTER;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.DISPLAY;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.DISPLAY_COLOR;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.LEFT;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.LOWER_LIMIT;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.MIN_AREA;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.RIGHT;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.UPPER_LIMIT;
import static org.firstinspires.ftc.teamcode.Core.Utils.EctoVision.Pipelines.BarcodePipeline.BarcodeConstants.VARIANCE;
  ...
  public Mat processFrame(Mat input) {
    ...
    try {
      ...
      Imgproc.findContours(
          processed, contours, new Mat(), Imgproc.RETR_LIST, Imgproc.CHAIN_APPROX_SIMPLE);
      ...
      for (MatOfPoint contour : contours) {
        ...
        if (contourArray.length >= 15) {
          ...
          // if rectangle is larger than previous cycle or if rectangle is not larger than previous
          // 6 cycles > then replace
