...
@Autonomous(name = "Blue46Pointer", group = "Red")
public class Blue46Pointer extends EctoOpMode {
  ...
  Pose2d allianceShippingPositionLevelOne = new Pose2d(-38.5, 23, Math.toRadians(0));

  Pose2d spinnerPosition = new Pose2d(-60.5, 57.5, Math.toRadians(0));
  ...
  // + Distances
  double levelOneForwardnessPreloaded = 0.1;
  double levelOneForwardnessDuck = 5.0;
  ...
  public void initRobotClasses() {
    ...
    trajectoryInitializer =
        drive.trajectorySequenceBuilder(startingPosition).strafeLeft(-1).build();
    ...
    levelOne =
        drive
            ...
            .lineToLinearHeading(allianceShippingPositionLevelOne)
            .addDisplacementMarker(
                () -> {
                  arm.setHomePosition();
